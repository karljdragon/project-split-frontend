...
//CONSTANT DECLARATIONS
    ...
    const [extensionUploadRef, setExtensionUploadRef] = useState(React.createRef());
        ...
        if(foundIn("Proof_for_Extension", missing_documents)){
            if(statement2UploadRef.current.files[0] !== undefined){
                let extensionData = {
                    ...
                    email: email,
                    JWT: JWT,
                    doc: extensionUploadRef.current.files[0],
                };
    ...
    function Extension() {
        return(
            <>
                ...
                <Grid item xs={12} sm={4} >
                    <input type='file' accept=".jpg,.pdf,.png,.jpeg" ref={extensionUploadRef}/>
                </Grid>
            </>
        );
    };
        ...
        <>
            ...
            <React.Fragment>
                <Grid container spacing={3}>
                    ...
                    {foundIn("Proof_For_Extension", missing_documents) && <Extension />}
                </Grid>
                <br/><br/>
                <React.Fragment>
